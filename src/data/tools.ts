...
export const toolsByCategory: Record<string, Tool[]> = {
  ...
  "finance": [
    ...
    },
    {
      ...
      description: 'Calculate monthly mortgage payments, loan amortization schedules, and total interest paid.',
      icon: '🏡',
      href: '/finance/mortgage-calculator',
    },
    {
      title: 'ROI Calculator',
      description: 'Calculate return on investment (ROI) percentage and annualized returns for any asset or project.',
      icon: '📈',
  ...
  description: 'Calculate Body Mass Index (BMI) with 6 WHO weight categories and an interactive visual gauge.',
  icon: '⚖️',
 ...
 href: '/math/percentage-calculator',
  ...
  description: 'Calculate area, perimeter, surface area, and volume for 2D and 3D geometric shapes.',
  icon: '📐',
  href: '/math/geometry-calculator',
  },
  {
  title: 'Statistics Calculator',
  description: 'Calculate mean, median, mode, variance, standard deviation, and quartiles for datasets.',
  icon: '📊',
  href: '/math/statistics-calculator',
  },
 {
 ...
 href: '/math/unit-converter',
  ...
  "pdf": [
  { title: 'PDF Merger', description: 'Drag, reorder, and combine multiple PDF files into a single document instantly.', icon: '🔗', href: '/pdf/pdf-merger' },
  { title: 'Split PDF By Range', description: 'Extract a specific page range (e.g. pages 3–8) from any PDF file.', icon: '✂️', href: '/pdf/pdf-split-range' },
  { title: 'Split PDF To Pages', description: 'Separate every PDF page into its own individual downloadable file.', icon: '📑', href: '/pdf/pdf-split-pages' },
  { title: 'Compose PDF', description: 'Create a PDF document from scratch using a built-in text editor.', icon: '✍️', href: '/pdf/pdf-compose' },
  { title: 'Protect PDF', description: 'Add password protection and set read/print/copy permissions on PDFs.', icon: '🔒', href: '/pdf/pdf-protect' },
  { title: 'Remove PDF Password', description: 'Unlock and remove password protection from a PDF file.', icon: '🔓', href: '/pdf/pdf-remove-password' },
  { title: 'Flatten PDF', description: 'Flatten form fields and annotations for universal compatibility.', icon: '📄', href: '/pdf/pdf-flatten' },
  { title: 'Preflight PDF', description: 'Inspect PDF metadata, page count, dimensions, and structure.', icon: '🔍', href: '/pdf/pdf-preflight' },
  { title: 'PDF to Text', description: 'Extract all readable text from any PDF document.', icon: '📝', href: '/pdf/pdf-to-text' },
  { title: 'PDF to Images', description: 'Convert each PDF page into a high-quality PNG image file.', icon: '🖼️', href: '/pdf/pdf-to-images' },
  { title: 'PDF to HTML', description: 'Convert PDF content into an HTML page you can preview and download.', icon: '🌐', href: '/pdf/pdf-to-html' },
  { title: 'Images to PDF', description: 'Combine multiple JPG/PNG/WebP images into a single PDF file.', icon: '🗂️', href: '/pdf/images-to-pdf' },
],
  "tools": [
  { title: 'PDF Merger', description: 'Drag, reorder, and combine multiple PDF files into a single document instantly.', icon: '🔗', href: '/pdf/pdf-merger' },
  { title: 'Split PDF By Range', description: 'Extract a specific page range (e.g. pages 3–8) from any PDF file.', icon: '✂️', href: '/pdf/pdf-split-range' },
